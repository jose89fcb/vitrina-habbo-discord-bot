...
async def vitrina(ctx,   keko, *, keko2):
    ...
    await ctx.send("Generando vitrina de habbo...", delete_after=0)
    time.sleep(3)
    ...
    ###
     ...
     img1 = cristal.resize((138,295), Image.ANTIALIAS)#tamaño de la cristal
    ...
    ###
     ...
     img1 = fondoazul.resize((138,295), Image.ANTIALIAS)#tamaño de la almo
